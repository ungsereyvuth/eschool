...
class user_addquestion{
	public function data($input){
		...
		$pageExist=true;
		returnStatus:
		return array('pageExist'=>$pageExist,'breadcrumb'=>$breadcrumb,'lesson_info'=>$lesson_info,'ordering'=>$ordering,'search_inputs'=>$search_inputs,'q_type'=>$q_type);
	}	
}
?>