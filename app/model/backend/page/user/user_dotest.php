...
class user_dotest{
	public function data($input){
		...
		//assign var
		$exam_result_id=0;$examdata=$subject_info=array();
		...
		$examdata = $qry->qry_assoc("select e.*,l.title lesson_title,r.id exam_result_id,r.answer,r.correctq,r.totalscore,r.start_datetime,r.end_datetime,r.elapsed_time,r.finished from es_exam e 
		...
		$questionnaire = renderq(array_keys(json_decode($examdata['question_ids'],true)));
