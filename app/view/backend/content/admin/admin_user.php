					...
					<div class="row">
		                ...
		                <div class="col-xs-12 col-sm-7">		                    
	                    	<div class="row margin-bottom-10">
	                            <div class="col-sm-6">
	                                	<label>Fullname (KH)</label>
	                                    <input type="text" name="fullname_kh" placeholder="Fullname (KH)" class="form-control" value="<?=$pageData->data->content->userinfo->fullname_kh?>">
	                            </div>
	                            <div class="col-sm-6">
	                                	<label>Fullname (EN)</label>
	                                    <input type="text" name="fullname_en" placeholder="Fullname (EN)" class="form-control" value="<?=$pageData->data->content->userinfo->fullname_en?>">
	                            </div>
	                        </div>
	                        <div class="row margin-bottom-10">
	                            <div class="col-sm-6">
