<div class="parallax-counter-v2 parallaxBg1" style="background-position: 50% 31px;">
    <div class="container bg-white">
        <div class="clearfix">
        	<div class="col-sm-5">
                <div class="headline">
                    <h3 class="khmerNormal"><?=$pageData->label->label->address->title?></h3>
                </div>
                <div class="shadow-wrapper">
                    <blockquote class="hero text-right box-shadow shadow-effect-3">
            ...
            <div class="col-sm-7">
            	<form class="ajaxfrm sky-form noborder" role="form" id="contactus-form" data-func="submit_form" data-reset="1" action="" method="post">
                    <div class="headline">
                    	<h3 class="khmerNormal"><?=$pageData->label->label->leave_message->title?></h3>
                    </div>
                    <div class="row">
                    	<div class="col-sm-6">
                            <section>
